...
-- A: We'll need to use a junction table (i.e., categories_employees), because this is a many-to-many relationship
-- One employee can be an expert in 0-many categories, and each category can belong to 0-many employees
...
CREATE TABLE categories_employees (
    employee_id INT,
    category_id INT,
...
ALTER TABLE categories_employees
...
INSERT INTO categories_employees (employee_id, category_id)
...
TRUNCATE TABLE categories_employees;
...
DROP TABLE categories_employees;